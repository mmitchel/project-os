...
# tegra-espimage does not need /etc/manifest.xml generation; disable the
# image_repo_manifest hook to avoid do_image repo warnings.
IMAGE_CLASSES:remove = "image_repo_manifest"
IMAGE_PREPROCESS_COMMAND:remove = "buildinfo_manifest;"
